...
namespace List.Tests
{
    public class DoubleLinkedListTests
    {
        ...
        public void AddDoubledLinkedListTest(int[] actualArray, int[] addingArray, int[] expectedArray)
        {
            DoubleLinkedList actual = new DoubleLinkedList(actualArray);
            DoubleLinkedList adding = new DoubleLinkedList(addingArray);
            actual.AddDoubledLinkedList(adding);
            DoubleLinkedList expected = new DoubleLinkedList(expectedArray);
            Assert.AreEqual(expected, actual);
        ...
        public void AddDoubledLinkedListToTheBeginingTest(int[] actualArray, int[] addingArray, int[] expectedArray)
        {
            DoubleLinkedList actual = new DoubleLinkedList(actualArray);
            DoubleLinkedList adding = new DoubleLinkedList(addingArray);
            actual.AddDoubledLinkedListToTheBegining(adding);
            DoubleLinkedList expected = new DoubleLinkedList(expectedArray);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void AddDoubledLinkedListByIndexTest(int[] actualArray, int[] addingArray, int index, int[] expectedArray)
        {
            DoubleLinkedList actual = new DoubleLinkedList(actualArray);
            DoubleLinkedList adding = new DoubleLinkedList(addingArray);
            actual.AddDoubledLinkedListByIndex(adding, index);
            DoubleLinkedList expected = new DoubleLinkedList(expectedArray);
            Assert.AreEqual(expected, actual);
        }
        [TestCase(new int[] { 1, 2, 3 }, new int[] { 4, 5, 6 }, -1)]
        [TestCase(new int[] { 1, 2, 3 }, new int[] { 4, 5, 6 }, 6)]
        public void AddDoubledLinkedListByIndex_WhenIndexOutOfRange_IndexOutOfRangeExpection(int[] actualArray, int[] addingArray, int index)
        {
            DoubleLinkedList actual = new DoubleLinkedList(actualArray);
            DoubleLinkedList adding = new DoubleLinkedList(addingArray);
            Assert.Throws<IndexOutOfRangeException>(() => actual.AddDoubledLinkedListByIndex(adding, index));
        }
        ...
        {
            DoubleLinkedList actualArr = new DoubleLinkedList(actualArray);
